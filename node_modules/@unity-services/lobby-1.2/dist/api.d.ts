...
export interface BulkUpdateRequest {
     ...
     */
    playerUpdates?: {
        [key: string]: PlayerUpdateRequest;
    } | null;
    /**
...
export declare const LobbyApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    bulkUpdateLobby: (lobbyId: string, serviceId?: string, impersonatedUserId?: string, bulkUpdateRequest?: BulkUpdateRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createLobby: (serviceId?: string, impersonatedUserId?: string, createRequest?: CreateRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    deleteLobby: (lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getHostedLobbies: (serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getJoinedLobbies: (serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getLobby: (lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    heartbeat: (lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    joinLobbyByCode: (serviceId?: string, impersonatedUserId?: string, joinByCodeRequest?: JoinByCodeRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    joinLobbyById: (lobbyId: string, serviceId?: string, impersonatedUserId?: string, player?: Player, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    queryLobbies: (serviceId?: string, impersonatedUserId?: string, queryRequest?: QueryRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    quickJoinLobby: (serviceId?: string, impersonatedUserId?: string, quickJoinRequest?: QuickJoinRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    reconnect: (lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    removePlayer: (lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    requestTokens: (lobbyId: string, tokenRequest: Array<TokenRequest>, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateLobby: (lobbyId: string, serviceId?: string, impersonatedUserId?: string, updateRequest?: UpdateRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updatePlayer: (lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, playerUpdateRequest?: PlayerUpdateRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const LobbyApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    bulkUpdateLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, bulkUpdateRequest?: BulkUpdateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Create a new lobby and return the lobby metadata.
     * @summary Create a lobby
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    createLobby(serviceId?: string, impersonatedUserId?: string, createRequest?: CreateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Delete a lobby so it\'s no longer discoverable/joinable.
     * @summary Delete a lobby
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    deleteLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Get a list of lobby IDs that are currently hosted by the player/service.
     * @summary Get a player/service\'s hosted lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    getHostedLobbies(serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>>;
    /**
     * Get a list of lobby IDs that the player is currently a member of.
     * @summary Get a player\'s joined lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    getJoinedLobbies(serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>>;
    /**
     * Get the full details for a lobby including the game-specific metadata and player details.
     * @summary Get lobby details
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    getLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Heartbeat a lobby, updating its `LastUpdated` property, to signify that the lobby is not stale.
     * @summary Heartbeat a lobby
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    heartbeat(lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Join an existing lobby using the lobby code if there is space available (i.e. total number of players is less than the value of `MaxPlayers`).
     * @summary Join a lobby with lobby code
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    joinLobbyByCode(serviceId?: string, impersonatedUserId?: string, joinByCodeRequest?: JoinByCodeRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Join an existing lobby using the lobby ID if there is space available (i.e. total number of players is less than the value of `MaxPlayers`).
     * @summary Join a lobby with lobby ID
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    joinLobbyById(lobbyId: string, serviceId?: string, impersonatedUserId?: string, player?: Player, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Query all of the public lobbies for a title and filter them down according to parameters provided by the client.
     * @summary Query public lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    queryLobbies(serviceId?: string, impersonatedUserId?: string, queryRequest?: QueryRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<QueryResponse>>;
    /**
     * Query all of the available lobbies for a title and filter them down according to parameters provided by the client.  If possible, join one and return its information.
     * @summary Query available lobbies and join a random one
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    quickJoinLobby(serviceId?: string, impersonatedUserId?: string, quickJoinRequest?: QuickJoinRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Reconnect a disconnected player to a lobby using the lobby ID.
     * @summary Reconnect to a lobby after disconnecting
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    reconnect(lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Remove an individual player from a lobby.  If the player being removed is the host, a random player is chosen as the new host.  Hosts can avoid this by changing the `hostId` to another player using the **Update Lobby** API before leaving.
     * @summary Remove a player
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    removePlayer(lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Request authentication tokens for use with other services that interact with Lobby.
     * @summary Authentication token request
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    requestTokens(lobbyId: string, tokenRequest: Array<TokenRequest>, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{
     ...
     * @throws {RequiredError}
     */
    updateLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, updateRequest?: UpdateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
    /**
     * Update the properties of a player.  Only the player matching the player ID can perform this action.  This could include updating the `data` property for an individual player to include game-specific metadata.  The index data property is not allowed on player data objects at this time.
     * @summary Update player data
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    updatePlayer(lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, playerUpdateRequest?: PlayerUpdateRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lobby>>;
};
/**
...
export declare const LobbyApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    bulkUpdateLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, bulkUpdateRequest?: BulkUpdateRequest, options?: any): AxiosPromise<Lobby>;
    /**
     * Create a new lobby and return the lobby metadata.
     * @summary Create a lobby
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    createLobby(serviceId?: string, impersonatedUserId?: string, createRequest?: CreateRequest, options?: any): AxiosPromise<Lobby>;
    /**
     * Delete a lobby so it\'s no longer discoverable/joinable.
     * @summary Delete a lobby
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    deleteLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: any): AxiosPromise<void>;
    /**
     * Get a list of lobby IDs that are currently hosted by the player/service.
     * @summary Get a player/service\'s hosted lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    getHostedLobbies(serviceId?: string, impersonatedUserId?: string, options?: any): AxiosPromise<Array<string>>;
    /**
     * Get a list of lobby IDs that the player is currently a member of.
     * @summary Get a player\'s joined lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    getJoinedLobbies(serviceId?: string, impersonatedUserId?: string, options?: any): AxiosPromise<Array<string>>;
    /**
     * Get the full details for a lobby including the game-specific metadata and player details.
     * @summary Get lobby details
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    getLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: any): AxiosPromise<Lobby>;
    /**
     * Heartbeat a lobby, updating its `LastUpdated` property, to signify that the lobby is not stale.
     * @summary Heartbeat a lobby
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    heartbeat(lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: any): AxiosPromise<void>;
    /**
     * Join an existing lobby using the lobby code if there is space available (i.e. total number of players is less than the value of `MaxPlayers`).
     * @summary Join a lobby with lobby code
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    joinLobbyByCode(serviceId?: string, impersonatedUserId?: string, joinByCodeRequest?: JoinByCodeRequest, options?: any): AxiosPromise<Lobby>;
    /**
     * Join an existing lobby using the lobby ID if there is space available (i.e. total number of players is less than the value of `MaxPlayers`).
     * @summary Join a lobby with lobby ID
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    joinLobbyById(lobbyId: string, serviceId?: string, impersonatedUserId?: string, player?: Player, options?: any): AxiosPromise<Lobby>;
    /**
     * Query all of the public lobbies for a title and filter them down according to parameters provided by the client.
     * @summary Query public lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    queryLobbies(serviceId?: string, impersonatedUserId?: string, queryRequest?: QueryRequest, options?: any): AxiosPromise<QueryResponse>;
    /**
     * Query all of the available lobbies for a title and filter them down according to parameters provided by the client.  If possible, join one and return its information.
     * @summary Query available lobbies and join a random one
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @throws {RequiredError}
     */
    quickJoinLobby(serviceId?: string, impersonatedUserId?: string, quickJoinRequest?: QuickJoinRequest, options?: any): AxiosPromise<Lobby>;
    /**
     * Reconnect a disconnected player to a lobby using the lobby ID.
     * @summary Reconnect to a lobby after disconnecting
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    reconnect(lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: any): AxiosPromise<Lobby>;
    /**
     * Remove an individual player from a lobby.  If the player being removed is the host, a random player is chosen as the new host.  Hosts can avoid this by changing the `hostId` to another player using the **Update Lobby** API before leaving.
     * @summary Remove a player
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    removePlayer(lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, options?: any): AxiosPromise<void>;
    /**
     * Request authentication tokens for use with other services that interact with Lobby.
     * @summary Authentication token request
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    requestTokens(lobbyId: string, tokenRequest: Array<TokenRequest>, serviceId?: string, impersonatedUserId?: string, options?: any): AxiosPromise<{
        [key: string]: TokenData;
    }>;
    /**
     * Update the properties of a lobby.  This could include the lobby name, number of max players, the lobby\'s `data` property, etc.
     ...
     * @throws {RequiredError}
     */
    updateLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, updateRequest?: UpdateRequest, options?: any): AxiosPromise<Lobby>;
    /**
     * Update the properties of a player.  Only the player matching the player ID can perform this action.  This could include updating the `data` property for an individual player to include game-specific metadata.  The index data property is not allowed on player data objects at this time.
     * @summary Update player data
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @throws {RequiredError}
     */
    updatePlayer(lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, playerUpdateRequest?: PlayerUpdateRequest, options?: any): AxiosPromise<Lobby>;
};
/**
...
export declare class LobbyApi extends BaseAPI {
     ...
     * @memberof LobbyApi
     */
    bulkUpdateLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, bulkUpdateRequest?: BulkUpdateRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Create a new lobby and return the lobby metadata.
     * @summary Create a lobby
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @memberof LobbyApi
     */
    createLobby(serviceId?: string, impersonatedUserId?: string, createRequest?: CreateRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Delete a lobby so it\'s no longer discoverable/joinable.
     * @summary Delete a lobby
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    deleteLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Get a list of lobby IDs that are currently hosted by the player/service.
     * @summary Get a player/service\'s hosted lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @memberof LobbyApi
     */
    getHostedLobbies(serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<string[]>>;
    /**
     * Get a list of lobby IDs that the player is currently a member of.
     * @summary Get a player\'s joined lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @memberof LobbyApi
     */
    getJoinedLobbies(serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<string[]>>;
    /**
     * Get the full details for a lobby including the game-specific metadata and player details.
     * @summary Get lobby details
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    getLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Heartbeat a lobby, updating its `LastUpdated` property, to signify that the lobby is not stale.
     * @summary Heartbeat a lobby
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    heartbeat(lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Join an existing lobby using the lobby code if there is space available (i.e. total number of players is less than the value of `MaxPlayers`).
     * @summary Join a lobby with lobby code
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @memberof LobbyApi
     */
    joinLobbyByCode(serviceId?: string, impersonatedUserId?: string, joinByCodeRequest?: JoinByCodeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Join an existing lobby using the lobby ID if there is space available (i.e. total number of players is less than the value of `MaxPlayers`).
     * @summary Join a lobby with lobby ID
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    joinLobbyById(lobbyId: string, serviceId?: string, impersonatedUserId?: string, player?: Player, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Query all of the public lobbies for a title and filter them down according to parameters provided by the client.
     * @summary Query public lobbies
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @memberof LobbyApi
     */
    queryLobbies(serviceId?: string, impersonatedUserId?: string, queryRequest?: QueryRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<QueryResponse>>;
    /**
     * Query all of the available lobbies for a title and filter them down according to parameters provided by the client.  If possible, join one and return its information.
     * @summary Query available lobbies and join a random one
     * @param {string} [serviceId] When service authentication is used, this provides a logical identity for the service
     ...
     * @memberof LobbyApi
     */
    quickJoinLobby(serviceId?: string, impersonatedUserId?: string, quickJoinRequest?: QuickJoinRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Reconnect a disconnected player to a lobby using the lobby ID.
     * @summary Reconnect to a lobby after disconnecting
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    reconnect(lobbyId: string, serviceId?: string, impersonatedUserId?: string, body?: object, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Remove an individual player from a lobby.  If the player being removed is the host, a random player is chosen as the new host.  Hosts can avoid this by changing the `hostId` to another player using the **Update Lobby** API before leaving.
     * @summary Remove a player
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    removePlayer(lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<void>>;
    /**
     * Request authentication tokens for use with other services that interact with Lobby.
     * @summary Authentication token request
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    requestTokens(lobbyId: string, tokenRequest: Array<TokenRequest>, serviceId?: string, impersonatedUserId?: string, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<{
        [key: string]: TokenData;
    }>>;
    /**
     * Update the properties of a lobby.  This could include the lobby name, number of max players, the lobby\'s `data` property, etc.
     ...
     * @memberof LobbyApi
     */
    updateLobby(lobbyId: string, serviceId?: string, impersonatedUserId?: string, updateRequest?: UpdateRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
    /**
     * Update the properties of a player.  Only the player matching the player ID can perform this action.  This could include updating the `data` property for an individual player to include game-specific metadata.  The index data property is not allowed on player data objects at this time.
     * @summary Update player data
     * @param {string} lobbyId The ID of the lobby to execute the request against.
     ...
     * @memberof LobbyApi
     */
    updatePlayer(lobbyId: string, playerId: string, serviceId?: string, impersonatedUserId?: string, playerUpdateRequest?: PlayerUpdateRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Lobby>>;
}
