 ...
 * @enum {string}
 */
export declare enum SettingsDeliveryRequestTypeEnum {
    Int = "int",
    Float = "float",
    Long = "long",
    Bool = "bool",
...
export declare const SettingsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    assignSettings: (settingsRequest: SettingsDeliveryRequest, options?: any) => Promise<RequestArgs>;
    /**
     *
     ...
     * @throws {RequiredError}
     */
    assignSettingsGet: (projectId: string, environmentId?: string, configType?: string, key?: Array<string>, schemaId?: Array<string>, type?: Array<"int" | "float" | "long" | "bool" | "string" | "json">, options?: any) => Promise<RequestArgs>;
};
/**
...
export declare const SettingsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    assignSettings(settingsRequest: SettingsDeliveryRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
    /**
     *
     * @summary Request settings for a user.
     * @param {string} projectId projectId for the requesting Unity project
     ...
     * @throws {RequiredError}
     */
    assignSettingsGet(projectId: string, environmentId?: string, configType?: string, key?: Array<string>, schemaId?: Array<string>, type?: Array<"int" | "float" | "long" | "bool" | "string" | "json">, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>>;
};
/**
...
export declare class SettingsApi extends BaseAPI {
     ...
     */
    assignSettings(settingsRequest: SettingsDeliveryRequest, options?: any): Promise<import("axios").AxiosResponse<object>>;
    /**
     *
     * @summary Request settings for a user.
     * @param {string} projectId projectId for the requesting Unity project
     ...
     * @memberof SettingsApi
     */
    assignSettingsGet(projectId: string, environmentId?: string, configType?: string, key?: Array<string>, schemaId?: Array<string>, type?: Array<"int" | "float" | "long" | "bool" | "string" | "json">, options?: any): Promise<import("axios").AxiosResponse<object>>;
}
