...
exports.FilesApi = exports.FilesApiFactory = exports.FilesApiFp = exports.FilesApiAxiosParamCreator = exports.DataApi = exports.DataApiFactory = exports.DataApiFp = exports.DataApiAxiosParamCreator = void 0;
...
exports.FilesApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createUploadUrl: function (projectId, playerId, filename, fileDetails, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'projectId' is not null or undefined
                            common_1.assertParamExists("createUploadUrl", "projectId", projectId);
                            // verify required parameter 'playerId' is not null or undefined
                            common_1.assertParamExists("createUploadUrl", "playerId", playerId);
                            // verify required parameter 'filename' is not null or undefined
                            common_1.assertParamExists("createUploadUrl", "filename", filename);
                            localVarPath = "/v1/files/projects/{projectId}/players/{playerId}/items/{filename}"
                                .replace("{" + "projectId" + "}", encodeURIComponent(String(projectId)))
                                .replace("{" + "playerId" + "}", encodeURIComponent(String(playerId)))
                        ...
                        case 1:
                            ...
                            headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                            localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                            localVarRequestOptions.data = common_1.serializeDataIfNeeded(fileDetails, localVarRequestOptions, configuration);
                            return [2 /*return*/, {
                                    url: common_1.toPathString(localVarUrlObj),
                                    options: localVarRequestOptions,
                                }];
         ...
         * @throws {RequiredError}
         */
        deleteFile: function (projectId, playerId, filename, writeLock, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'projectId' is not null or undefined
                            common_1.assertParamExists("deleteFile", "projectId", projectId);
                            // verify required parameter 'playerId' is not null or undefined
                            common_1.assertParamExists("deleteFile", "playerId", playerId);
                            // verify required parameter 'filename' is not null or undefined
                            common_1.assertParamExists("deleteFile", "filename", filename);
                            localVarPath = "/v1/files/projects/{projectId}/players/{playerId}/items/{filename}"
                                .replace("{" + "projectId" + "}", encodeURIComponent(String(projectId)))
                                .replace("{" + "playerId" + "}", encodeURIComponent(String(playerId)))
                                .replace("{" + "filename" + "}", encodeURIComponent(String(filename)));
         ...
         * @throws {RequiredError}
         */
        getFileUrl: function (projectId, playerId, filename, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'projectId' is not null or undefined
                            common_1.assertParamExists("getFileUrl", "projectId", projectId);
                            // verify required parameter 'playerId' is not null or undefined
                            common_1.assertParamExists("getFileUrl", "playerId", playerId);
                            // verify required parameter 'filename' is not null or undefined
                            common_1.assertParamExists("getFileUrl", "filename", filename);
                            localVarPath = "/v1/files/projects/{projectId}/players/{playerId}/items/{filename}"
                                .replace("{" + "projectId" + "}", encodeURIComponent(String(projectId)))
                                .replace("{" + "playerId" + "}", encodeURIComponent(String(playerId)))
                                .replace("{" + "filename" + "}", encodeURIComponent(String(filename)));
         ...
         * @throws {RequiredError}
         */
        getProjectDetails: function (projectId, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'projectId' is not null or undefined
                            common_1.assertParamExists("getProjectDetails", "projectId", projectId);
                            localVarPath = "/v1/files/projects/{projectId}".replace("{" + "projectId" + "}", encodeURIComponent(String(projectId)));
                            localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
                            }
         ...
         * @throws {RequiredError}
         */
        listFiles: function (projectId, playerId, after, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'projectId' is not null or undefined
                            common_1.assertParamExists("listFiles", "projectId", projectId);
                            // verify required parameter 'playerId' is not null or undefined
                            common_1.assertParamExists("listFiles", "playerId", playerId);
         ...
         * @throws {RequiredError}
         */
        setupFileStorage: function (projectId, fileStorageSetupDetails, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            // verify required parameter 'projectId' is not null or undefined
                            common_1.assertParamExists("setupFileStorage", "projectId", projectId);
                            localVarPath = "/v1/files/projects/{projectId}".replace("{" + "projectId" + "}", encodeURIComponent(String(projectId)));
                            localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
                            if (configuration) {
                                baseOptions = configuration.baseOptions;
                        ...
                        case 1:
                            ...
                            headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                            localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                            localVarRequestOptions.data = common_1.serializeDataIfNeeded(fileStorageSetupDetails, localVarRequestOptions, configuration);
                            return [2 /*return*/, {
                                    url: common_1.toPathString(localVarUrlObj),
                                    options: localVarRequestOptions,
                                }];
    ...
    return {
        ...
        createUploadUrl: function (projectId, playerId, filename, fileDetails, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.createUploadUrl(projectId, playerId, filename, fileDetails, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        deleteFile: function (projectId, playerId, filename, writeLock, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.deleteFile(projectId, playerId, filename, writeLock, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        getFileUrl: function (projectId, playerId, filename, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getFileUrl(projectId, playerId, filename, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        getProjectDetails: function (projectId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getProjectDetails(projectId, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        listFiles: function (projectId, playerId, after, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.listFiles(projectId, playerId, after, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
        ...
        setupFileStorage: function (projectId, fileStorageSetupDetails, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.setupFileStorage(projectId, fileStorageSetupDetails, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)];
                    }
...
exports.FilesApiFactory = function (configuration, basePath, axios) {
    ...
    return {
        ...
        createUploadUrl: function (projectId, playerId, filename, fileDetails, options) {
            return localVarFp
                .createUploadUrl(projectId, playerId, filename, fileDetails, options)
                .then(function (request) { return request(axios, basePath); });
        },
        /**
         * Deletes the specified file. If a WriteLock is provided, the file will only be deleted if it matches the stored WriteLock.
        ...
        deleteFile: function (projectId, playerId, filename, writeLock, options) {
            return localVarFp
                .deleteFile(projectId, playerId, filename, writeLock, options)
                .then(function (request) { return request(axios, basePath); });
        },
        /**
         * Generates a signed URL that will allow the client to download the requested file for a limited period of time.  If successful, an object will be returned containing all necessary information to perform the download.
        ...
        getFileUrl: function (projectId, playerId, filename, options) {
            return localVarFp
                .getFileUrl(projectId, playerId, filename, options)
                .then(function (request) { return request(axios, basePath); });
        },
        /**
         * Returns details about a Cloud Save project. In this version, only the provisioning status is returned.
        ...
        listFiles: function (projectId, playerId, after, options) {
            return localVarFp
                .listFiles(projectId, playerId, after, options)
                .then(function (request) { return request(axios, basePath); });
        },
        /**
         * Provisions a bucket for the project if one does not already exist using the data from the request body as labels for the bucket.  If successful, a bucket will be created and made available for further files operations.
        ...
        setupFileStorage: function (projectId, fileStorageSetupDetails, options) {
            return localVarFp
                .setupFileStorage(projectId, fileStorageSetupDetails, options)
                .then(function (request) { return request(axios, basePath); });
        },
    };
};
...
var FilesApi = /** @class */ (function (_super) {
     ...
     * @memberof FilesApi
     */
    FilesApi.prototype.createUploadUrl = function (projectId, playerId, filename, fileDetails, options) {
        var _this = this;
        return exports.FilesApiFp(this.configuration)
            .createUploadUrl(projectId, playerId, filename, fileDetails, options)
            .then(function (request) { return request(_this.axios, _this.basePath); });
    };
    /**
     ...
     * @memberof FilesApi
     */
    FilesApi.prototype.deleteFile = function (projectId, playerId, filename, writeLock, options) {
        var _this = this;
        return exports.FilesApiFp(this.configuration)
            .deleteFile(projectId, playerId, filename, writeLock, options)
            .then(function (request) { return request(_this.axios, _this.basePath); });
     ...
     * @memberof FilesApi
     */
    FilesApi.prototype.getFileUrl = function (projectId, playerId, filename, options) {
        var _this = this;
        return exports.FilesApiFp(this.configuration)
            .getFileUrl(projectId, playerId, filename, options)
            .then(function (request) { return request(_this.axios, _this.basePath); });
     ...
     * @memberof FilesApi
     */
    FilesApi.prototype.getProjectDetails = function (projectId, options) {
        var _this = this;
        return exports.FilesApiFp(this.configuration)
            .getProjectDetails(projectId, options)
            .then(function (request) { return request(_this.axios, _this.basePath); });
     ...
     * @memberof FilesApi
     */
    FilesApi.prototype.listFiles = function (projectId, playerId, after, options) {
        var _this = this;
        return exports.FilesApiFp(this.configuration)
            .listFiles(projectId, playerId, after, options)
            .then(function (request) { return request(_this.axios, _this.basePath); });
     ...
     * @memberof FilesApi
     */
    FilesApi.prototype.setupFileStorage = function (projectId, fileStorageSetupDetails, options) {
        var _this = this;
        return exports.FilesApiFp(this.configuration)
            .setupFileStorage(projectId, fileStorageSetupDetails, options)
            .then(function (request) { return request(_this.axios, _this.basePath); });
