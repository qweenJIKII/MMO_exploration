 ...
 * @export
 */
export type BadRequestOneOfErrorResponse =
  | BasicErrorResponse
...
export const FilesApiAxiosParamCreator = function (
  ...
  return {
    ...
    createUploadUrl: async (
      ...
      // verify required parameter 'projectId' is not null or undefined
      assertParamExists("createUploadUrl", "projectId", projectId);
      // verify required parameter 'playerId' is not null or undefined
      assertParamExists("createUploadUrl", "playerId", playerId);
      // verify required parameter 'filename' is not null or undefined
      assertParamExists("createUploadUrl", "filename", filename);
      const localVarPath =
        `/v1/files/projects/{projectId}/players/{playerId}/items/{filename}`
          .replace(`{${"projectId"}}`, encodeURIComponent(String(projectId)))
          .replace(`{${"playerId"}}`, encodeURIComponent(String(playerId)))
    ...
    getFileUrl: async (
      ...
      // verify required parameter 'projectId' is not null or undefined
      assertParamExists("getFileUrl", "projectId", projectId);
      // verify required parameter 'playerId' is not null or undefined
      assertParamExists("getFileUrl", "playerId", playerId);
      // verify required parameter 'filename' is not null or undefined
      assertParamExists("getFileUrl", "filename", filename);
      const localVarPath =
        `/v1/files/projects/{projectId}/players/{playerId}/items/{filename}`
          .replace(`{${"projectId"}}`, encodeURIComponent(String(projectId)))
          .replace(`{${"playerId"}}`, encodeURIComponent(String(playerId)))
    ...
    getProjectDetails: async (
      ...
      const localVarPath = `/v1/files/projects/{projectId}`.replace(
        `{${"projectId"}}`,
    ...
    listFiles: async (
      ...
      // verify required parameter 'projectId' is not null or undefined
      assertParamExists("listFiles", "projectId", projectId);
      // verify required parameter 'playerId' is not null or undefined
      assertParamExists("listFiles", "playerId", playerId);
      const localVarPath =
     ...
     * @throws {RequiredError}
     */
    setupFileStorage: async (
      projectId: string,
      fileStorageSetupDetails?: FileStorageSetupDetails,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'projectId' is not null or undefined
      assertParamExists("setupFileStorage", "projectId", projectId);
      const localVarPath = `/v1/files/projects/{projectId}`.replace(
        `{${"projectId"}}`,
        encodeURIComponent(String(projectId))
      );
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getProjectDetails(projectId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.setupFileStorage(
          projectId,
          fileStorageSetupDetails,
          options
        );
...
export class FilesApi extends BaseAPI {
   ...
   * @memberof FilesApi
   */
  public getProjectDetails(projectId: string, options?: AxiosRequestConfig) {
    return FilesApiFp(this.configuration)
      .getProjectDetails(projectId, options)
      .then((request) => request(this.axios, this.basePath));
  }
