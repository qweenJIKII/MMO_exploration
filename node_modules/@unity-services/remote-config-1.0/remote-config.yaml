...
components:
  ...
  securitySchemes:
    JWT:
      ...
      scheme: bearer
      description: >
        Requests must include as a bearer token the access token provided by the
        Authentication service when logging-in or signing-up a player.
        The access token's private claims include player and project IDs which
        are used to authorise the request.