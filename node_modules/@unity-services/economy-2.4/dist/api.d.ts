...
export declare const CurrencyResourceTypeEnum: {
    readonly Currency: "CURRENCY";
};
export declare type CurrencyResourceTypeEnum = typeof CurrencyResourceTypeEnum[keyof typeof CurrencyResourceTypeEnum];
/**
...
export declare const InventoryItemResourceTypeEnum: {
    readonly InventoryItem: "INVENTORY_ITEM";
};
export declare type InventoryItemResourceTypeEnum = typeof InventoryItemResourceTypeEnum[keyof typeof InventoryItemResourceTypeEnum];
/**
 *
 * @export
...
export interface PlayerConfigurationResponse {
    /**
     *
     * @type {PlayerConfigurationResponseMetadata}
     * @memberof PlayerConfigurationResponse
     */
    metadata?: PlayerConfigurationResponseMetadata;
    /**
     ...
     * @memberof PlayerConfigurationResponse
     */
    results: Array<CurrencyResource | InventoryItemResource | VirtualPurchaseResource | RealMoneyPurchaseResource>;
}
/**
 * Contains information about the results.
 * @export
 * @interface PlayerConfigurationResponseMetadata
 */
export interface PlayerConfigurationResponseMetadata {
    /**
     * Hash representing the exact version of the configuration in the response.
     * @type {string}
     * @memberof PlayerConfigurationResponseMetadata
     */
...
export declare const RealMoneyPurchaseResourceTypeEnum: {
    readonly MoneyPurchase: "MONEY_PURCHASE";
};
export declare type RealMoneyPurchaseResourceTypeEnum = typeof RealMoneyPurchaseResourceTypeEnum[keyof typeof RealMoneyPurchaseResourceTypeEnum];
/**
 * Store identifiers.
 * @export
...
export declare const VirtualPurchaseResourceTypeEnum: {
    readonly VirtualPurchase: "VIRTUAL_PURCHASE";
};
export declare type VirtualPurchaseResourceTypeEnum = typeof VirtualPurchaseResourceTypeEnum[keyof typeof VirtualPurchaseResourceTypeEnum];
/**
...
export declare const ConfigurationApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getPlayerConfiguration: (projectId: string, playerId: string, configAssignmentHash?: string, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ConfigurationApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getPlayerConfiguration(projectId: string, playerId: string, configAssignmentHash?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlayerConfigurationResponse>>;
};
/**
...
export declare const ConfigurationApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
     ...
     * @throws {RequiredError}
     */
    getPlayerConfiguration(projectId: string, playerId: string, configAssignmentHash?: string, options?: any): AxiosPromise<PlayerConfigurationResponse>;
};
/**
...
export declare class ConfigurationApi extends BaseAPI {
     ...
     */
    getPlayerConfiguration(requestParameters: ConfigurationApiGetPlayerConfigurationRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<PlayerConfigurationResponse>>;
}
/**
